...
default['monit']['loadavg']['1min'] = { 'value' => 4, cycles: 2 }
default['monit']['loadavg']['5min'] = { 'value' => 2, cycles: 2 }
default['monit']['memory'] = { 'value' => '75%', cycles: 2 }
default['monit']['cpu']['user'] = { 'value' => '70%', cycles: 2 }
default['monit']['cpu']['system'] = { 'value' => '30%', cycles: 2 }
default['monit']['cpu']['wait'] = { 'value' => '20%', cycles: 2 }
